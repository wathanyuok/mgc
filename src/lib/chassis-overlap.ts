...
// "roll over" = สัญญาถูกแทนที่ด้วยฉบับใหม่แล้ว รถไปอยู่กับฉบับใหม่ ฉบับเดิมจึงไม่ถือรถอีก
// ถ้าไม่คัดออก พอต่อสัญญาแล้วจะเอารถคันเดิมใส่ฉบับใหม่ไม่ได้ เพราะระบบฟ้องว่าซ้ำกับฉบับเก่า
const CLOSED = ['closed', 'repaid', 'cancelled', 'terminated', 'rejected', 'expired', 'converted', 'roll over'];
